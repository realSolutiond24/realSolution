...
const Cart = () => {
    ...
    const [customPopupVisibility, setCustomPopupVisibility] = useState(false);
    ...
    const confirmOrder = async () => {
        ...
        try {
            ...
            setCartItems([]);
            setTotal(0);
            setCustomPopupVisibility(true);
            console.log(customPopupVisibility)
        } catch (error) {
    ...
    return (
        <div>
                ...
                {loading ? (
                    ...
                    <>
                        <textarea
                            ...
                            maxLength={100}
                            style={{ height: 20, minHeight: 20, width: '95%', paddingLeft: 10, borderWidth: 1, borderColor: deliveryAddress ? 'black' : 'red', borderRadius: 5, marginTop: 5, borderStyle: 'solid', fontSize: 16, maxHeight: '61px', outlineStyle: 'none' }}
                        />
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', gap: '0.5%' }} >
                            <input
                                ...
                                style={{ height: 20, width: '50%', paddingLeft: 10, borderWidth: 1, borderColor: 'red', borderRadius: 5, marginBottom: 5, marginTop: 1, borderStyle: 'solid', fontSize: 16, outlineStyle: 'none' }}
                            />
                            <input
                        ...
                        <div style={{ marginTop: '0px', fontSize: '18px', fontWeight: 'bold', textAlign: 'right' }}>
                            Total: ₹{total}
                        </div>
                        <button
            ...
            <div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'absolute', bottom: 65 }} >
                <div onClick={() => navigate('/realSolution/Home')} style={{ width: '95%', height: 40, backgroundColor: '#ff6347', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 5 }} >Continue Purchasing</div>
            </div>
            <CustomPopup display={customPopupVisibility ? 'block' : 'none'} />
